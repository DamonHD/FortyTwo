Trivial pre-V1.5-IDE AVR-only library that provides the answer to life, the universe, and everything.

This shows the structure of the source, test project and packaged item.
